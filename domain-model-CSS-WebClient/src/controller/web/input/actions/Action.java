...
public abstract class Action {
	...
	// duplicated code
	protected boolean isInt(Helper help, String num, String message) {
		try {
	...
	protected boolean isFilled (Helper helper, String value, String message) {
